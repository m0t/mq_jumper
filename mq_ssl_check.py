...
parser.add_option("-c", "--channels", action="store", dest="channels", default="mq_channels.txt", metavar="channels", help="channels file, default:mq_channels.txt")
parser.add_option("-s", "--ciphers", action="store", dest="ciphers", default="ssl_ciphers.txt", metavar="ciphers", help="SSL ciphers files, default:ssl_ciphers.txt")
...
file = options.ciphers
file2 = options.channels
...
for channel in fd.readlines():
    ...
    for cipher in fd2.readlines():
        ...
        try:
            ...
            print("failed to set cipher, skipping")
            continue
